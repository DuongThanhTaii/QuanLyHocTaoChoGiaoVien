...
export const PRICING_PLANS = [
  ...
  },
  {
    ...
    features: [
      "Không giới hạn số lớp & học sinh",
      ...
      "Kho lưu trữ tài liệu & bài tập dung lượng cao",
      "Báo cáo phân tích doanh thu chuyên sâu",
      "Hỗ trợ kỹ thuật ưu tiên 24/7",
    ],
  },
  {
    name: "Trung Tâm / Tổ Hợp",
    tier: "enterprise",
    ...
    features: [
      ...
      "Quản lý nhiều giáo viên & trợ giảng",
      "Phân quyền quản trị viên / nhân viên học vụ",
      "Báo cáo tài chính & chia hoa hồng tự động",
      "Tùy biến thương hiệu & logo riêng",
      "Kèm hợp đồng & hóa đơn VAT điện tử",
      "Quản lý tài khoản chuyên trách riêng (Account Manager)",
    ],
  },
];
