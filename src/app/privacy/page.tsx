...
import { ArrowLeft, HardDrive, LockKeyhole, Mail, ShieldCheck, type LucideIcon } from 'lucide-react';
    ...
    <main className="pt-16">
      ...
      <article className="mx-auto max-w-4xl px-5 py-12 sm:py-16">
        ...
        <div className="mt-12 space-y-12 leading-7 text-slate-700 dark:text-zinc-300">
          <PolicySection icon={HardDrive} title="1. Quyền Google Drive được dùng để làm gì?">
          ...
          <PolicySection icon={ShieldCheck} title="2. Dữ liệu Mari xử lý">
          ...
          <PolicySection icon={LockKeyhole} title="3. Cách dữ liệu được bảo vệ">
          ...
          <PolicySection icon={ShieldCheck} title="4. Chia sẻ và thời gian lưu trữ">
          ...
          <PolicySection icon={Mail} title="5. Quyền của bạn và liên hệ">
...
function PolicySection({ icon: Icon, title, children }: { icon: LucideIcon; title: string; children: ReactNode }) {
  return <section>
    <h2 className="flex items-center gap-3 text-2xl font-semibold tracking-tight text-slate-900 dark:text-white"><Icon className="size-5 text-orange-600" />{title}</h2>
