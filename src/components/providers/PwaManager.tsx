...
export function PwaManager() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      if (!canAskAgain || isStandalone() || !isIos()) return;
      setShowIosHint(true);
    }, 3000);
