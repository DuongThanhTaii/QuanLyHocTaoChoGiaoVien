...
import { DEFAULT_STROKE_WIDTH, scaledStrokeWidth } from "./types";
import { motion, useAnimate } from "motion/react";
import type { HTMLMotionProps } from "motion/react";

export interface BookIconProps extends Omit<HTMLMotionProps<"div">, "ref"> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

const BookIcon = forwardRef<AnimatedIconHandle, BookIconProps>(
  (
    { size = 20, color = "currentColor", strokeWidth = DEFAULT_STROKE_WIDTH, className = "", ...props },
    ref,
  ) => {
