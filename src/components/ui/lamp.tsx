...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[520px] md:min-h-[620px] flex-col items-center justify-center overflow-hidden w-full rounded-none z-0 bg-slate-950 text-white",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-slate-950 blur-[8rem]"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-amber-400/80 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
      ...
      <div className="relative z-50 flex -translate-y-56 md:-translate-y-64 flex-col items-center px-4">
        {children}
      </div>
    </div>
  );
